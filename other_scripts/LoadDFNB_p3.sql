...
-----   ----------   -----------   -------------------------------------------------------------------------------
1.0     12/14/2020   BRUNOFREITAS  1. Creation of the Script
2.0	12/16/2020   BRUNOFREITAS  2. Enhancements on the script considering the feedbacks received.

RUNTIME: 
Approx. 1 min

NOTES:
Loading DFNB_STG_P2 - Project 2 database, that includes all tables of project 1, 2 tables of project 2, and 1 new table for project 3.
